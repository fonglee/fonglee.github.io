	...
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				<p class="text1"><span id="text-75" contenteditable="true">阿峰</span> ❤ <span id="text-76" contenteditable="true">小璐</span> <span id="text-77" contenteditable="true">一生一世</span></p>
			...
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				<p class="top-text" id="text-1" contenteditable="true">过去的阿峰一直是一个人生活，享受着孤独，也憧憬着爱情。</p>
				<img src='img/iali63.jpg'  alt="过去的阿峰一直是一个人生活，享受着孤独，也憧憬着爱情。" />
			</div>
		...
		<div class="ft-section section-3" data-id="section-3">
			...
			<div id="/section-3/page-3" class="ft-page page-13" data-id="page-3">
				<img src='img/iali64.jpg' alt='可是阿峰的爱情又在哪里呢？' />
				<h3 id="text-13" contenteditable="true">可是阿峰的爱情又在哪里呢？</h3>
			</div>
			...
			<div id="/section-3/page-6" class="ft-page page-16 left-img" data-id="page-6">
				<h3><span id="text-17" contenteditable="true">于是，阿峰一个人继续向前走</span><br /><span id="text-18" contenteditable="true">走在茫茫的雪地上</span></h3>
				<img src='img/iali66.jpg' />
			</div>
			<div id="/section-3/page-7" class="ft-page page-17 top-text" data-id="page-7">
				<h3 id="text-19" contenteditable="true">直到有一天阿峰与小璐相遇了</h3>
		...
		<div class="ft-section section-4" data-id="section-4">
			...
			<div id="/section-4/page-7" class="ft-page page-24 full-img" data-id="page-7">	
				<h3 id="text-26" contenteditable="true">晚上阿峰会把小璐送回家</h3>
		...
		<div class="ft-section section-5" data-id="section-5">
			...
			<div id="/section-5/page-7" class="ft-page page-31" data-id="page-7">
				<h3 id="text-34" contenteditable="true">于是阿峰开始学习新的技能</h3>
		...
		<div class="ft-section section-6" data-id="section-6">
			...
			<div id="/section-6/page-4" class="ft-page page-35" data-id="page-4">
				<h3><span id="text-38" contenteditable="true">阿峰感觉自己好幸福。</span><br /><span id="text-39" contenteditable="true">因为自己有了家</span><br /><span id="text-40" contenteditable="true">那个有小璐在的地方</span></h3>
		...
		<div class="ft-section section-7" data-id="section-7">
			...
			<div id="/section-7/page-3" class="ft-page page-41" data-id="page-3">
				...
				<h3 id="text-46" contenteditable="true"> 阿峰又怎会飞的更高更远</h3>
			</div>
			<div id="/section-7/page-4" class="ft-page page-42" data-id="page-4">
				<h3><span id="text-47" contenteditable="true">阿峰不想这样。他要为小璐改变自己</span><br /><span id="text-48" contenteditable="true">小璐说她喜欢狮子座的人，于是阿峰许下愿望</span></h3>
			...
			<div id="/section-7/page-7" class="ft-page page-45 left-img" data-id="page-7">
				<h3><span id="text-52" contenteditable="true">再到后来，小璐要过生日了</span><br /><span id="text-53" contenteditable="true">阿峰开始为小璐准备礼物</span></h3>
		...
		<div class="ft-section section-8" data-id="section-8">
			<div id="/section-8/page-1" class="ft-page page-46" data-id="page-1">
				...
				<h3>
					...
					<span id="text-55" contenteditable="true">阿峰好开心</span>
					<span id="text-56" contenteditable="true">因为他想象着小璐收到礼物时</span>
			...
			<div id="/section-8/page-2" class="ft-page page-47 top-text" data-id="page-2">
				...
				<h3>
					...
					<span id="text-59" contenteditable="true">阿峰好开心</span>
					<span id="text-60" contenteditable="true">因为可以和小璐</span>
			...
			<div id="/section-8/page-3" class="ft-page page-48 left-img" data-id="page-3">
				<p><span id="text-62" contenteditable="true">阿峰也会继续努力</span><br /><span id="text-63" contenteditable="true">为了他和小璐的梦之城堡</span></p>
				<img src='img/iali65.jpg'  />
			</div>
			<div id="/section-8/page-4" class="ft-page page-49 full-img" data-id="page-4">
			<img src='img/iali71.jpg' />
				<p class="text">
					<span class='text' id="text-64" contenteditable="true">阿峰很幸福，因为他找到了小璐。他相信后面的每天都会是快乐的</span><br />
					<span class='text' id="text-65" contenteditable="true">简简单单，体会着与小璐在一起的每一个刻</span>
				</p>
			</div>
			<div id="/section-8/page-5" class="ft-page page-50" data-id="page-5">
				<p class='text' id="text-66" contenteditable="true">后来的一天，小璐说她不敢坐山车了，于是阿峰就带她到别的地方玩。这只是他们幸福生活中的一件小事，小到无法引起别人的注意。可这是属于阿峰和小璐的幸福生活。</p>
			...
			<div id="/section-8/page-6" class="ft-page page-51" data-id="page-6">
				<p>
					<span id="text-67" contenteditable="true">小璐：永远有多远？</span><br />
					<span id="text-68" contenteditable="true">阿峰：比时间多一秒就是永远，我会永远爱你</span><br />
					<span id="text-69" contenteditable="true">小璐：世界有多大？</span><br />
					<span id="text-70" contenteditable="true">阿峰：你走到哪里，世界就有多大</span>
					</p>
			</div>
		</div>
		<div class="ft-section section-9" data-id="section-9">
			...
			<div id="/section-9/page-4" class="ft-page page-55 right-img" data-id="page-4">
				...
				<p class="text">
					<span id="text-73" contenteditable="true">阿峰和小璐的故事会一直继续下去。</span><br />
